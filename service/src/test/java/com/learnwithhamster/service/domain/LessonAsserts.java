...
public class LessonAsserts {
    ...
    public static void assertLessonUpdatableFieldsEquals(Lesson expected, Lesson actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getLessonTitle()).as("check lessonTitle").isEqualTo(expected.getLessonTitle()))
            .satisfies(a -> assertThat(a.getLessonDescription()).as("check lessonDescription").isEqualTo(expected.getLessonDescription()))
