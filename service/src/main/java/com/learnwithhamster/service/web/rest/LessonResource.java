...
/**
 * REST controller for managing {@link com.learnwithhamster.service.domain.Lesson}.
 */
@RestController
...
public class LessonResource {
    ...
    private static final String ENTITY_NAME = "serviceLesson";
    ...
    /**
     * {@code SEARCH  /lessons/_search?query=:query} : search for the lesson corresponding
     * to the query.
     *
