...
export class DisciplineService {
  ...
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/disciplines', 'service');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/disciplines/_search', 'service');
  ...
  search(req: Search): Observable<EntityArrayResponseType> {
    ...
    return this.http
      ...
      .pipe(catchError(() => scheduled([new HttpResponse<IDiscipline[]>()], asapScheduler)));
  }
